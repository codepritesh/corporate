...
if(isset($_POST['submit']))
{
    ...
    $fetch=mysql_query("select * from `bank` where `bankname`='$name'");
    $res=mysql_num_rows($fetch);
    if($res==0)
    {
    mysql_query("insert into `bank` set `bankname`='$name'");
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Add Bank Name</h2>
		    ...
		    Name of the Bank<input type="text" name="name" class="form-control"  autocomplete="off"  required style="width: 300;">
                    </br>
...
<div class="box-content">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a href="bankedit.php?id=<?php echo  $rprefix['id'];?>" style="color: #009999;cursor: pointer;">EDIT</a></td>
                        <td><span onClick="return del(<?php echo  $rprefix['id'];?>);" style="color: #009999;cursor: pointer;">DELETE</span></td>
                    </tr>
                    </tr>
                    <?php }?>
                </table>
