    ...
    <div class="box col-md-12">
        <div class="box-inner">
			...
			<th>Loan Given</th>
                    ...
                    <?php
                    //echo "select * from `$table` where `is_approved`!='0' and `loan_accno`=''";
                    $fetchapp=mysql_query("select * from $table where `is_approved`!='0' and `loan_accno`=''");
			...
			<td><?php echo $resapp['loangiven'];?></td>
                        ...
                        <td> <?php if(strtotime($resapp['loan_given_date']) <= strtotime($currdt)){?><a href="<?php echo $table; ?>_security.php?id=<?php echo  $resapp['id'];?>"><input type="button" name="despatch" value="Dispatch"></a><?php }else{ ?><?php } ?></td>
                    </tr>
                    <?php }?>
                </table>
	    </div>
