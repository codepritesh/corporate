...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
		    ...
		    $totloan=0;
		    $total=0;
                    $fetchapp=mysql_query("select * from $table where `is_approved`!='0'");
		    if(mysql_num_rows($fetchapp)>0){
                    while($resapp=mysql_fetch_array($fetchapp))
                    {
			$i++;
                    ?>
                    <tr>
			...
			<td><?php echo $resapp['loan_accno'];?></td>
                        <td><?php echo date("d-m-Y",strtotime($resapp['loan_given_date']));?></td>
			<td><?php echo $resapp['loangiven'];?></td>
			<td><?php echo $resapp['odintrest'];?></td>
			<td><?php echo $resapp['odprincipal'];?></td>
			<td><?php echo $resapp['amount_topay'];?></td>
                    </tr>
                    <?php $total=$total+$resapp['amount_topay'];
		    $totodp=$totodp+$resapp['odprincipal'];
		    $totodi=$totodi+$resapp['odintrest'];
		    $totloan=$totloan+$resapp['loangiven']; } ?>
		    <tr><td colspan="4" style="text-align: center;">Total</td>
			<td><?php echo number_format($totloan, 2, '.', '') ;?></td>
			<td><?php echo number_format($totodi, 2, '.', '') ;?></td>
			<td><?php echo number_format($totodp, 2, '.', '') ;?></td>
