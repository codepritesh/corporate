...
<script>
    $(function(){
        ...
        var edate=$('#edate').val();
        $.ajax({
        url: "fixedsearch.php?sdt="+sdate+"&edt="+edate,
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Fixed Deposit Accounts Report</h2>
			...
			<!-- <th>Till Date Maturity Amount</th>-->
			 <th>Opening Date</th>
			 <th>Maturity Date</th>
			...
			<!--<td><?php echo$res['year'].' Yr';?></td>-->
			<td><?php echo$res['deposited_amt'];?></td>
			<td><?php echo $res['intrest_rate'];?></td>
			<td><?php echo $res['maturity_amt'];?></td>
			<!-- <td><?php echo $res['till_maturity_amt'];?></td>-->
			<td><?php echo date("d-m-Y",strtotime($res['opening_date']));?></td>
			<td><?php echo date("d-m-Y",strtotime($res['closing_date']));?></td>
                    </tr>
                    <?php }?>
		    <tr >
			<td colspan="3" style="text-align: center;">Total Deposited Amount:</td><td colspan="6"><?php echo number_format($tot, 2, '.', '');?></td>
		    </tr>
		    <tr >
