...
$saccdetails=mysql_query("select * from `compulsarydeposite` where `status`='0'")or die(mysql_error());
...
$(function(){
	...
	//alert(cid);
        $.ajax({
            url:"compulsory_ajax.php?acc="+acc,
...
function validate()
	...
	if (parseFloat(wamt) > parseFloat(damt)) {
	    alert("You have not sufficient balance to withdraw "+wamt+" amount");
	    document.getElementById("with_amt").value='';
	    document.getElementById("with_amt").focus();
	    return false;
	}
	if (parseFloat(wamt) < 4000) {
	    alert("Maximum amount for withdrawl is 4000");
	    //document.getElementById("with_amt").value='';
	    //document.getElementById("with_amt").focus();
	    //return false;
	}
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Saving Account Withdrawal Form</h2>
            ...
            <div class="box-content" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
                <form name="arrange" action="compulsorywith_action.php" method="post" onsubmit="return validate();" enctype="multipart/form-data">
