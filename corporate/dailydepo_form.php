...
<script src="js/jquery-ui.js"></script>
 <!--autocomplete end-->
  <script type="text/javascript"> 
	...
	//alert(cid);
        $.ajax({
            url:"ajax_dailyaccdetails.php?acc="+acc,
...
$('#mat_amt').val(maturity_amount.toFixed(2));  
	...
	if (parseFloat(deposited_amt)<1) {
		    alert("Please insert Deposited_amt greter than zero");
		    document.getElementById("deposited_amt").focus();
		    return false;
		}
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Daily Account Deposite Form</h2>
            ...
            <div class="box-content" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
                <form name="arrange" action="insert_dailydepo.php" method="post" onSubmit="return validate();" enctype="multipart/form-data">
			...
			<tr>
                            <td>A/c No</td><td style="float: left;width: 300px;"><select name="acc_no" data-placeholder="&nbsp;"  class="form-control chosen-select " required id="acc_no" style="width:307px; padding:4px;height: 100px;border-radius:4px;">
										<option value=""></option>
										<?php echo $accno;?>
									   </select>
                        ...
                        <tr>
						     <td>Daily Deposite Amount</td>
							 <td>
							<input type="text" name="paidamt" id="deposited_amt" class="form-control" onkeyPress="return IsNumeric(event,this.value)" required ></td>
						    </td>
