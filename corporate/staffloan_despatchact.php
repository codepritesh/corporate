...
$fetch=mysql_query("select * from `staffloan` where `id`='$id'");
...
mysql_query("update `loanaccno` set `accno`='$id1'");
    //echo "update `staffloan` set `loan_accno`='SL$id',`loan_given_date`='$date' where `id`='$id'";
    mysql_query("update `staffloan` set `loan_accno`='SL$id1',`loan_given_date`='$date',`od_cal_date`='$date' where `id`='$id'")or die(mysql_error());
    
    /*echo "</br>insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='SL$id'
                 ,`amount`='-$loan',`date`='$date',`details`='Staff Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt'";*/
    mysql_query("insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='SL$id1'
                 ,`amount`='-$res[loangiven]',`date`='$date',`details`='Staff Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt',`folio_no`='23',`voucher`='$voucher',`type`='loan'")or die(mysql_error());
    //header("location:loan_despatch.php?table=staffloan");
    header("location:ledger.php?id=$id&table=staffloan");
}
$id=$_GET['id'];
?>
<html lang="en">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Staff Loan Disbursement</h2>
