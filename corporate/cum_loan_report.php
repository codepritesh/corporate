    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Transaction Principal & Interest Collection Report</h2>
                        ...
                        <tr id="bydate">
							...
							<td>
								<select name="type" class="form-control">
									...
									<option value="businessloan">Bussiness Loan</option>
            ...
            <div class="box-content" id="printDiv">
                 ...
                 <table  class="table">
                   <tr>
                    <th style="text-align: center;">
                      <?php if($type!=''){ echo ucwords($type); }else{ echo "Loan";};?> Transaction Report <?php echo $title;?>
                    </th>
                   </tr>
                 </table>
                <table  class="table">                    
		     ...
		     //echo "SELECT * FROM `transaction_ledger` where `collection`>0 $dt $var";
                     $qwe= mysql_query("SELECT * FROM `transaction_ledger` where `collection`>0 $dt $var");
                    if(mysql_num_rows($qwe)>0){						
                     ...
                     $n++;
                     $tot_od_int=$tot_od_int+$res['b_od_int'];
                     $tot_cr_int=$tot_cr_int+$res['b_cur_int'];
                     $tot_od_pr=$tot_od_pr+$res['b_od_pri'];
                     $tot_cr_pr=$tot_cr_pr+$res['b_cur_pri'];
                     $tot_pre_pr=$tot_pre_pr+$res['a_pre_pri'];
                     $tot_coll=$tot_coll+$res['collection'];
                     ...
                     <tr>
                        ...
                        <td><?php echo $res['b_od_int'];?></td>
                        <td><?php echo $res['b_cur_int'];?></td>
                        <td><?php echo $res['b_od_pri'];?></td>
                        <td><?php echo $res['b_cur_pri'];?></td>
                        <td><?php echo $res['a_pre_pri'];?></td>
						<td><?php echo $res['b_od_pri']+$res['b_cur_pri']+$res['a_pre_pri'];?></td>
                     ...
                     <tr style="text-align: center;">
                        ...
                        <th><?php echo $tot_od_int; ?></th>
                        <th><?php echo $tot_cr_int;?></th>
                        <th><?php echo $tot_od_pr;?></th>
                        <th><?php echo $tot_cr_pr;?></th>
                        <th><?php echo $tot_pre_pr;?></th>
						 <th><?php echo $tot_od_pr+$tot_cr_pr+$tot_pre_pr;?></th>
						<th><?php echo $tot_coll;?></th>
                       <!-- <th>--</th> -->
                     </tr>
					 <tr style="text-align: center;">
                        <th colspan='3' style="text-align: center;"> </th>
                        <th colspan='2'style="text-align: center;">Total Interest : <?php echo $tot_od_int+$tot_cr_int;?></th>                        
                        <th colspan='4' style="text-align: center;">Total Principal : <?php echo $tot_od_pr+$tot_cr_pr+$tot_pre_pr;?></th>
						<th style="text-align: center;">Total Collection : <?php echo $tot_coll;?></th>
                      <!--  <th>--</th> -->
                     </tr>
					 <?php }else{ ?>
					 <tr style="text-align: center;">
                        <th colspan='10' style="text-align: center;">No Results Found</th>                        
                     </tr>
					 <?php } ?>
                </table>
                <table class="table">
