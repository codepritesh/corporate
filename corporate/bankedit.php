...
{
$name=$_POST['name'];
mysql_query("update  `bank` set  `bankname`='$name' where `id`='$id'")or die(mysql_error());
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Edit Bank</h2>
                ...
                <form name="arrange" action="" method="post" onSubmit="return validate();" enctype="multipart/form-data">
                    <table style="float: left;width: 100%;">
                        <tr>
                            ...
                            <?php
                             $fetch1=mysql_query("select * from `bank` where `id`='$id'") or die(mysql_error());
                            $res1=mysql_fetch_array($fetch1);
                            ?>
                            <td>
                               <input type="text" name="name" id="name" value="<?php echo $res1['bankname'];?>" autocomplete="off"  class="form-control" required style="width: 300; float:left;autocomplete:off;">
                            </td>
                        </tr>
                        <tr>
                            <td>
