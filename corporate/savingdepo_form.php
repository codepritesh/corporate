...
<script>
	...
	/*var intid=document.getElementById("agentid").value;
	if (intid=='') {
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Voluntary Saving Account Deposite Form</h2>
            ...
            <div class="box-content" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
                <form name="arrange" action="insert_savingdepo.php" method="post" onSubmit="return validate();" enctype="multipart/form-data">
			...
			<tr>
			    ...
			    <!--<input type="text" name="acc_no" id="acc_no" class="form-control" required >-->
                            <td>Deposite Amount</td><td><input type="text" name="paidamt" id="paid" class="form-control" onkeyPress="return IsNumeric(event,this.value)" required></td>
			    ...
			    <td>Voucher no</td><td style="float: left;width: 320px;"><input type="text" name="voucher" id="voucher" value=""  onKeyPress="return numbersonly(event);"  class="form-control" required ></td>
