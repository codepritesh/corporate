...
<script>
    $(function(){
        ...
        var edate=$('#edate').val();
        $.ajax({
        url: "compulsorysearch.php?sdt="+sdate+"&edt="+edate,
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
			...
			<tr>
                            <td>Start Date</td><td><input type="text" name="sdate" class="form-control" id="sdate" required></td>
                            <td>End Date</td><td><input type="text" name="edate" class="form-control" id="edate" required ></td>
            ...
            <div class="box-content">
			 ...
			 <th>Opening Date</th>
                    ...
                    <?php
                    $fetch=mysql_query("select * from `compulsarydeposite` and `status`=0");
