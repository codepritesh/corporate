   ...
   // echo "</br>";
    ...
    if($table=='compulsarydeposite')
    {
	 ...
	 $sqlagent=mysql_query("select * from `agent`")or die(mysql_error());
	  //$sqlagent=mysql_query("select * from `agent` where `prodetails`='Enterprise Loan'")or die(mysql_error());
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Enterprise Loan Form</h2>
	...
	<!----pop up end------>
                <form name="arrange" action="enterpriseloan_details_action.php" method="post"  enctype="multipart/form-data">
			...
			<th>Loan Given</th>
                    ...
                    <?php
                    $fetchapp=mysql_query("select * from `enterpriseloan` where `is_approved`='1'");
