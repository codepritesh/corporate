...
$getvendor=mysql_query("SELECT * FROM businessloan where `is_approved`='1' and `loan_accno`!='' and `loancomplited`='0'") or die(mysql_error());
...
<script type="text/javascript"> 
	...
	//alert(cid);
        $.ajax({
            url:"businessloan_refund_ajax.php?cid="+cid,
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Business Loan Repayment</h2>
            ...
            <div class="box-content" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
                <form name="arrange" action="businessloanrefund_action.php" method="post" onSubmit="return validate();" enctype="multipart/form-data">		
