...
<script>
    $(function(){
        ...
        var edate=$('#edate').val();
        $.ajax({
        url: "savingsearch.php?sdt="+sdate+"&edt="+edate,
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Saving Voluntary Account Report</h2>
			...
			<th>Customer_ID</th>
			 ...
			 <th>Opening Date</th>
                    ...
                    <?php
					//echo "select * from `savingaccount` order by `id` desc";
                    $fetch=mysql_query("select * from `savingaccount` order by `id` desc");
		    $tot=0;
		    $i=0;
			...
			<td><?php echo  date("d-m-Y",strtotime($res['opening_date']));?></td>
                    <?php }?>
		    <tr style="color: red;">
			<td colspan="3" style="text-align: center;color: red;">Total Deposited Amount:</td><td colspan="3"><?php echo number_format($tot, 2, '.', '');?></td>
		    </tr>
		    <tr >
