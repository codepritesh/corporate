...
mysql_query("update `loanaccno` set `accno`='$id1'");
    //echo "update `grouploan` set `loan_accno`='GRL$id',`loan_given_date`='$date' where `id`='$id'";
    mysql_query("update `grouploan` set `loan_accno`='GRL$id1',`loan_given_date`='$date',`od_cal_date`='$date' where `id`='$id'")or die(mysql_error());
    
    /*echo "</br>insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='GRL$id'
    ...
    mysql_query("insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='GRL$id1'
                 ,`amount`='-$res[loangiven]',`date`='$date',`details`='Group Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt',`folio_no`='6',`voucher`='$voucher',`type`='loan'")or die(mysql_error());
    //header("location:loan_despatch.php?table=grouploan");
    header("location:ledger.php?id=$id&table=grouploan");
}
$id=$_GET['id'];
?>
<html lang="en">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Group Loan Disbursement</h2>
