    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Loan Status Report</h2>
			...
			<th>Loan Given</th>
                        <th>Loan Dispatch Date</th>
                        <th>Details</th>
                        <th>Action</th>
                    </tr>
                    <?php
                    //echo "select * from `loan` where `is_approved`!='0'";
                    $fetchapp=mysql_query("select * from `demand_loan` where `is_approved`!='0' and `loan_accno`=''");
		    if(mysql_num_rows($fetchapp)>0){
			...
			<td><?php echo $resapp['loangiven'];?></td>
                        <td><?php echo $resapp['loan_given_date'];?></td>
                        <td><?php if($resapp['is_approved']==1) { echo "Approved";}else{ echo "Not Approved";}?></td>
                        <td><?php if(strtotime($resapp['loan_given_date']) <= strtotime($currdt)){?><a href="demandloan_security.php?id=<?php echo  $resapp['id'];?>"><input type="button" name="despatch" value="Dispatch"></a><?php }else{ ?><?php } ?></td>
                    </tr>
                    <?php } } else{ ?>
		    <tr>
