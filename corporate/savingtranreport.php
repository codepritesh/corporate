        ...
        <div class="box-inner">
            ...
            <div class="box-content" id="print">
                <table class="table" id="srch" >
                    ...
                    <?php } ?>
		    <tr >
			    <td colspan="2" style="text-align: center; color: red;">Total Deposited Amount:</td><td style="text-align: center; color: red;" colspan="3"><?php echo number_format($tot, 2, '.', '');?></td>
		    </tr>
		    <tr >
