...
$getvendor=mysql_query("SELECT * FROM grouploan where `is_approved`='1' and `loan_accno`!='' and `loancomplited`='0'") or die(mysql_error());
...
<script type="text/javascript"> 
	...
	var cid=$(this).val();
        $.ajax({
            url:"grouploan_refund_ajax.php?cid="+cid,
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Group Loan Repayment</h2>
            ...
            <div class="box-content" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
                <form name="arrange" action="grouploanrefund_action.php" method="post" onSubmit="return validate();" enctype="multipart/form-data">		
		   <table style="float: left;width: 100%;">
			...
			<tr>
			    <td>Intrest Amount</td><td><input type="text" name="intamt" class="form-control" id="intamt" required readonly></td>
			    <td>Principal Amount</td><td><input type="text" name="principal" class="form-control" id="principal" readonly></td>
			</tr>
			<tr>
			    <td>PrePrincipal Amount</td><td><input type="text" name="preprincipal" class="form-control" id="preprincipal" readonly></td>
