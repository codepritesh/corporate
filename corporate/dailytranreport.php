        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <form name="arrange" method="post"  enctype="multipart/form-data">
                     <table style="float: left;width: 100%;">
                        ...
                        <tr id="bydate">
                            <td><input type="text" name="acc_no" id="acc_no" class="form-control" required placeholder="Account Number" autocomplte="off"></td>
            ...
            <div class="box-content" id="print">
                <table class="table" id="srch" >
                    ...
                    <?php
                    $fetch=mysql_query("select * from $table where `status`='0' and `opening_date`='$cdate' ");
                    ...
                    <tr>
						...
						<td><?php  echo $yr = ($res['plan'])." Years";?></td>
			...
			<td><?php echo  date("d-m-Y",strtotime($res['opening_date']));?></td>
                    ...
                    <?php } ?>
		    <tr >
			    <td colspan="4" style="text-align: center;color: red;">Total Deposited Amount:</td><td colspan="3" style="text-align: center;color: red;"><?php echo number_format($tot, 2, '.', '');?></td>
		    </tr>
		    <tr >
