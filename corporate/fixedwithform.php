 ...
 <!--autocomplete end-->
  ...
  $(this).val((ui.item ? ui.item.id : ""));
		...
		var valshow=ui.item.value;
		 ...
		 $('#maturity_amt').val(ui.item.maturity_amt);
		}
	...
	//alert(cid);
        $.ajax({
            url:"ajax_fixedcalaccdetails.php?acc="+acc,
            success: function(result){
		var obj = JSON.parse(result);
                 $('#account').val(obj.account);
									$('#customer_id').val(obj.customer_id);
                 $('#maturity_amt').val(obj.maturity_amt);
...
return false //disable key press
	...
	if (intid=='') {
	    ...
	    var mamt=document.getElementById("maturity_amt").value;
	    if (mamt=='') {
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Fixed Withdrawal Form</h2>
            ...
            <div class="box-content" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
                <form name="arrange" action="insert_fixedwith.php" method="post" onSubmit="return validate();" enctype="multipart/form-data">
			...
			<tr>
                            ...
                            <td>Maturity Amount</td><td><input type="text" name="maturity_amt" id="maturity_amt" class="form-control"  required></td>
			    <input type="hidden" name="account" id="account">
                            <input type="hidden" name="customer_id" id="customer_id">
                            <input type="hidden" name="deposited_amt" id="deposited_amt">
			</tr>
			<tr>
                    <td>Principal Amount</td><td style="width: 300px;"><input class="form-control" type="text"  name="principal" id="principal"></td>
                    <td>Interest Amount</td><td><input type="text" class="form-control"  name="interest" id="interest"></td>
