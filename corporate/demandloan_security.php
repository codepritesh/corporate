...
$res=mysql_fetch_array($fetch);
    ...
    if($security!='' && $security>0){
        mysql_query("update `demand_loan` set `security_amount`='$security' where `id`='$id'")or die(mysql_error());
    ...
    header("location:demandloan_despatchact.php?id=$id");
}
$id=$_GET['id'];
?>
<html lang="en">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Add Security for Demand Loan</h2>
