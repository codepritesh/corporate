...
else
{
   ...
   // echo "</br>";
    ...
    if($table=='compulsarydeposite')
    {
	 ...
	 //$sqlagent=mysql_query("select * from `agent` where `prodetails`='Agriculture Loan'")or die(mysql_error());
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Agriclture Loan Form</h2>
		...
		<table class="table" style="width:100%; height:250px; font-family:Arial, Helvetica, sans-serif; font-size:13px; color:#333;">
                    <?php
	...
	<!----pop up end------>
                <form name="arrange" action="agricultureloan_details_action.php" method="post"  enctype="multipart/form-data">
			...
			<th>Loan Given</th>
                    ...
                    <?php
                    $fetchapp=mysql_query("select * from `agricultureloan` where `is_approved`='1'");
