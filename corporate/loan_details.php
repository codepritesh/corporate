...
else
{
   ...
   // echo "</br>";
    ...
    if($table=='compulsarydeposite')
    {
	 ...
	 //$sqlagent=mysql_query("select * from `agent` where `prodetails`='Daily Loan'")or die(mysql_error());
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Daily Loan Form</h2>
...
<!----pop up------> 
	...
	<!----pop up end------>
                <form name="arrange" action="loan_details_action.php" method="post"  enctype="multipart/form-data">
			...
			<tr>
			   ...
			   <td><input type="text" name="chqddno" id="d1" class="form-control"  placeholder="Cheque/DD Number" onKeyPress="return numbersonly(event)" style="display: none;"></td>
                        ...
                        <tr >
			    <td align="center" colspan="2"><input type="submit" id="button" name="allow" value="Allow" onclick="return validate();"/></td>
			...
			<th>Loan Given</th>
                    ...
                    <?php
                    $fetchapp=mysql_query("select * from `loan` where `is_approved`='1'");
