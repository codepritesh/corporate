    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Compulsory Ledger Report</h2>
            ...
            <div class="box-content" id="print">
                <table class="table" id="srch" >
                    ...
                    <?php
                    $fetch=mysql_query("select * from $table where `status`='0' and  `startdate`='$cdate'");
		    $tot=0;
			...
			<td><?php echo  date("d-m-Y",strtotime($res['startdate']));?></td>
                    ...
                    <?php }?>
		     <tr >
			    <td colspan="3" style="text-align: center;color: red;">Total Deposited Amount:</td><td colspan="2" style="text-align: center;color: red;"><?php echo number_format($tot, 2, '.', '');?></td>
		    </tr>
		    <tr >
