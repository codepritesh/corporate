...
$fetch=mysql_query("select * from `goldloan` where `id`='$id'");
...
mysql_query("update `loanaccno` set `accno`='$id1'");
    //echo "update `goldloan` set `loan_accno`='G$id',`loan_given_date`='$date' where `id`='$id'";
    mysql_query("update `goldloan` set `loan_accno`='GL$id1',`loan_given_date`='$date',`od_cal_date`='$date' where `id`='$id'")or die(mysql_error());
    
    /*echo "</br>insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='GL$id'
                 ,`amount`='-$loan',`date`='$date',`details`='Gold Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt'";*/
    mysql_query("insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='GL$id1'
                 ,`amount`='-$res[loangiven]',`date`='$date',`details`='Gold Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt',`folio_no`='11',`voucher`='$voucher',`type`='loan'")or die(mysql_error());
    
    //header("location:demandscheduler.php?id=$id&table=goldloan");
    header("location:demandledger.php?id=$id&table=goldloan");
}
$id=$_GET['id'];
?>
<html lang="en">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Gold Loan Disbursement</h2>
