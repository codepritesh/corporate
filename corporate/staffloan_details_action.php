...
if(isset($_POST['allow']))
{
    ...
    mysql_query("update `staffloan` set `is_approved`='1',`loangiven`='$loan',`intrestrate`='$intrate',
	...
	header("location:loan_despatch.php?table=staffloan");
        ...
        header("location:staffloan_details.php?id=$id&msg=$msg");
    }
}
...
mysql_query("delete from `staffloan` where `id`='$id'") or die(mysql_error());
header("location:loan_approve.php?table=staffloan");
}
?>