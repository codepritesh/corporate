...
else
{
   ...
   // echo "</br>";
    ...
    if($table=='compulsarydeposite')
    {
	 ...
	 //$sqlagent=mysql_query("select * from `agent` where `prodetails`='Staff Loan'")or die(mysql_error());
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Staff Loan Form</h2>
			...
			<td><?php echo  date("d-m-Y",strtotime($resamount['startdate']));?></td>
                    ...
                    <tr>
                     ...
                     <?php
							...
							$loan7=mysql_query("select * from `staffloan` where `customer_id`='$res[customer_id]' and `is_approved`='1' and `loan_accno`!=''");
                            $loan8=mysql_query("select * from `businessloan` where `customer_id`='$res[customer_id]' and `is_approved`='1' and `loan_accno`!=''");
		           ...
		           while($loanres7=mysql_fetch_array($loan7))
                    ...
                    <?php }
					while($loanres8=mysql_fetch_array($loan8))
                    {
                    ?>
                    <tr><td><?php echo $loanres8['loan_accno'];?></td><td><?php echo $loanres8['loan_accno'];?></td><td><?php echo $loanres8['amount_topay'];?></td><td><?php if($loanres8['loancomplited']==1) {echo "complited";}else{ echo "continuing";}?></td></tr>
                    <?php } ?>
	...
	<!----pop up end------>
                <form name="arrange" action="staffloan_details_action.php" method="post"  enctype="multipart/form-data">
			...
			<th>Loan Given</th>
                    ...
                    <?php
                    $fetchapp=mysql_query("select * from `staffloan` where `is_approved`='1'");
