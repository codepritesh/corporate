    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Print Scheduler</h2>
            ...
            <div class="box-content" id="printDiv" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
             <form name="arrange" method="post" action="print.php" enctype="multipart/form-data">
                     <table style="float: left;width: 100%;">
                        ...
                        <tr>
                           ...
                           <td>
                                <input type="text" class="form-control" required name="accno" />
                           </td>
