...
<script src="js/jquery-ui.js"></script>
 <!--autocomplete end-->
  <script type="text/javascript"> 
   /* $(function(){
	 //jQuery.noConflict();
        var availabledrugs=<?php echo json_encode($rdetails); ?>;
        $('#acc_no').autocomplete({
  ...
  $(this).val((ui.item ? ui.item.id : ""));
		...
		var valshow=ui.item.value;
		 ...
		 $('#deposited_amt').val(ui.item.deposited_amt);
		}
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Saving Account Withdrawl Form</h2>
            ...
            <div class="box-content" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
                <form name="arrange" action="insert_savingwith.php" method="post" onsubmit="return validate();" enctype="multipart/form-data">
            ...
            <tr>
			    <td>Interest Amount</td><td><input type="text" name="int_amt" id="int_amt" class="form-control" onkeyPress="return IsNumeric(event,this.value)" required></td>
			    <td>Total Amount</td><td><input type="text" name="tot_amt" id="tot_amt" class="form-control" onkeyPress="return IsNumeric(event,this.value)" required></td>
			</tr>
			<tr>
