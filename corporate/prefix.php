...
if(isset($_POST['submit']))
{
    ...
    $fetch=mysql_query("select * from `prefix` where `name`='$name'");
    $res=mysql_num_rows($fetch);
    if($res==0)
    {
    mysql_query("insert into `prefix` set `name`='$name',`date`='$dt'");
    ...
    header("location:prefix.php?msg=$msg");
}
?>
<html lang="en">
<head>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i> Creat Agent Prefix</h2>
		    ...
		    Area Code<input type="text" name="name" class="form-control" required autocomplete="off" style="width: 300;">
                    </br>
		    Date<input type="text" name="date" id="date" class="form-control" required  autocomplete="off" style="width: 300;" onkeyPress="return IsNumeric(event,this.value)">
                    </br>
...
<div class="box-content">
			 ...
			 <th>Collection Date</th>
                    ...
                    <?php
                    $fetprefix=mysql_query("select * from prefix");
                    while($rprefix=mysql_fetch_array($fetprefix))
                    {
                    ?>
                    <tr>
                        <td><?php echo  $rprefix['name'].'('.$rprefix['slno'].')';?></td>
			<td><?php echo  date("d",strtotime($rprefix[date]));?></td>
                    </tr>
                    <?php }?>
                </table>
</div>
