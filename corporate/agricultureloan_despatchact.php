...
$fetch=mysql_query("select * from `agricultureloan` where `id`='$id'");
...
mysql_query("update `loanaccno` set `accno`='$id1'");
    ...
    $date=date("Y-m-d");
    $time=time();
    //echo "update `agricultureloan` set `loan_accno`='AL$id',`loan_given_date`='$date' where `id`='$id'";
    mysql_query("update `agricultureloan` set `loan_accno`='AL$id1',`loan_given_date`='$date',`od_cal_date`='$date' where `id`='$id'")or die(mysql_error());
    
    /*echo "</br>insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='AL$id'
                 ,`amount`='-$loan',`date`='$date',`details`='Business Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt'";*/
    mysql_query("insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='AL$id1'
                 ,`amount`='-$res[loangiven]',`date`='$date',`details`='Agriculture Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt',`folio_no`='7',`voucher`='$voucher',`type`='loan'")or die(mysql_error());
    //header("location:loan_despatch.php?table=agricultureloan");
    header("location:ledger.php?id=$id&table=agricultureloan");
}
$id=$_GET['id'];
?>
<html lang="en">
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Agriculture Loan Disbursement</h2>
