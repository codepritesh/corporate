        ...
        $(function () {
            ...
            $("#enddate").datepicker({
                ...
                onSelect: function (selected) {
                    var dt = new Date(selected);
                    dt.setDate(dt.getDate() - 1);
                    $("#strdate").datepicker("option", "maxDate", dt);
                }
            });
        });
    </script>
...
<script>
    $(function(){
        ...
        $.ajax({
        url: "dailysearch.php?sdt="+sdate+"&edt="+edate,
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Daily Deposit Report</h2>
			...
			<tr>
                            <td>From</td><td><input type="text" name="sdate" id="strdate" onKeyPress="return IsNumeric(event)"  class="form-control"  required></td>
                            <td>To</td><td><input type="text" name="edate" id="enddate" onKeyPress="return IsNumeric(event)"  class="form-control"  required ></td>
                            <td align="center" colspan="2"><input type="button" name="submit" value="Search" id="search" /></td>
			...
			<td><?php if($res['status']=='0'){ echo "Active"; }else{ echo "Inactive";}?></td>
                    ...
                    <?php }?>
		    <tr style="color:red;">
			    <td colspan="5" style="text-align: center;">Total Deposited Amount:</td><td colspan="4"><?php echo number_format($tot, 2, '.', '');?></td>
		    </tr>
		    <tr >
