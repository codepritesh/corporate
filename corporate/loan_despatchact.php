...
mysql_query("update `loanaccno` set `accno`='$id1'");
    //echo "update `loan` set `loan_accno`='L$id',`loan_given_date`='$date' where `id`='$id'";
    mysql_query("update `loan` set `loan_accno`='L$id1',`loan_given_date`='$date' where `id`='$id'")or die(mysql_error());
    
    /*echo "</br>insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='L$id'
                 ,`amount`='-$loan',`date`='$date',`details`='Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt'";*/
    mysql_query("insert into `transaction` set `transactionid`='$time',`customerid`='$res[customer_id]',`accountno`='L$id1'
                 ,`amount`='-$res[loangiven]',`date`='$date',`details`='Loan',`mode_of_payment`='$payment_mode',
                 `chq_dd_no`='$chkno',`chq_dd_bank_name`='$bank',`chq_dd_date`='$chkdt',`folio_no`='12',`voucher`='$voucher',`type`='loan'")or die(mysql_error());
   $msg="Successfully Submited...";
    //header("location:loan_despatch.php?table=loan&msg=$msg");
