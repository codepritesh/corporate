...
$accno=$_POST['accno'];
$table=$_POST['table'];
$s=mysql_query("select * from $table  where `loan_accno`='$accno'")or die(mysql_error());
$rs=mysql_num_rows($s);
if($rs>0)
{
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content" id="printDiv" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
              <?php if($table=="demand_loan" || $table=="goldloan"){?>
			...
			<tr>
				...
				?>
				Security Amount :<?php  if($res['loan_against_acc']=='compulsarydeposite' || $res['loan_against_acc']=='dailydeposit'){echo $ressec['total_amt'];   }else{ echo $ressec['deposited_amt']; } ?>
			...
			<?php
			  $sdl=mysql_query("select * from $table where `loan_accno`='$accno'")or die(mysql_error());
			  ...
			  <tr class="tableprint" style="line-height: 0.7;">
			    <td><?php echo $cnt; ?></td>
			    <td><?php echo date("d-m-Y",strtotime($ressdl['loan_given_date'])); ?></td>
			    <td>--</td>
			    <td>--</td>
			    <td>--</td>
			...
			<tr>
			   ...
			   <td><?php if($i==1 && $ldd != $d){
				...
				?></td>
			    <td><?php  if($i==1 && $ldd != $d){ echo $loanamtt = $ressdl['loangiven']; }else{ echo number_format("$loanamtt",2); }  ?></td>
			</tr>
                            <?php
                            $pre_dt=$final;
                            }}
           ...
           <table style="float: left;width: 100%; font-family:arial; font-size:14px;" >
			...
			<tr>
			   ...
			   <!--<td>Loan Dispersal</td>-->
			    <td><?php echo $daydiff; ?> Days</td>
			    <td><?php  echo number_format("$intrest",2); $totint=$totint+$intrest; ?></td>
			    <td><?php if($i==1 && $ldd != $d){ echo $tpr = 0.00; }else{  $tpr =$emi;  echo number_format("$emi",2); }  $totpr=$totpr+$tpr; ?></td>
			    <td><?php if($i==1 && $ldd != $d){
				$tot1=round($intrest);
				echo number_format("$tot1",2);
				}
