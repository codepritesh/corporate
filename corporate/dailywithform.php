    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content" style="width:100%; float:left;height: auto;background-color: #fff;border: #f5f5f5 solid 0.5px; border-radius: 4px;-webkit-box-shadow: 0 0 10px rgba(189,189,189,.4);">
                <form name="arrange" action="dailywith_action.php" method="post" onsubmit="return validate();" enctype="multipart/form-data">
			...
			<tr>
			    ...
			    <td>Total Deposited Amount</td><td><input type="text" name="deposited_amt" id="deposited_amt" class="form-control" readonly ></td>
