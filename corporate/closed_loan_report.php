    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content" id="printDiv">
		     ...
		     //echo "SELECT * FROM `transaction_ledger` where `collection`>0 and `outstanding`=0 $dt $var";
                     $qwe= mysql_query("SELECT * FROM `transaction_ledger` where `collection`>0 and `outstanding`=0 $dt $var");
