...
mysql_query("UPDATE `corporate1`.`transaction_ledger` SET `outstanding` = '25701.00', `a_od_pr` = '6383.81', `a_tot_od` = '6383.81' WHERE `transaction_ledger`.`id` = 7409");
...
mysql_query("DELETE FROM `corporate1`.`transaction` WHERE `transaction`.`id` = 24960 ");

mysql_query("UPDATE `corporate1`.`transaction` SET `amount` = '17832.00' WHERE `transaction`.`id` = 24961");

mysql_query("UPDATE `corporate1`.`transaction_ledger` SET `b_od_pri` = '7155.72', `b_cur_int` = '0.00', `a_pre_pri` = '10676.28' WHERE `transaction_ledger`.`id` = 13298");

mysql_query("UPDATE `corporate1`.`businessloan` SET `amount_topay` = '0', `odprincipal` = '0', `pre_principal` = '10676.28', `last_refund_amt` = '17832.00', `od_cal_date` = '2016-09-10' WHERE `businessloan`.`id` = 218");
...
mysql_query("UPDATE `corporate1`.`transaction_ledger` SET `a_od_pr` = '5247.30', `a_tot_od` = '5247.30' WHERE `transaction_ledger`.`id` = 11790 ");
...
mysql_query("UPDATE `corporate1`.`transaction_ledger` SET `b_od_pri` = '5082.00', `tot_pr` = '5082.00', `outstanding` = '57647.05', `a_od_pr` = '147.95', `a_tot_od` = '147.95' WHERE `transaction_ledger`.`id` = 14466 ");

mysql_query("update `enterpriseloan` set `odintrest`='0.00',`odprincipal`='147.95',`amount_topay`='57647.05',`od_cal_date`='2016-11-21' where `loan_accno`='EL1757' ");

mysql_query(" DELETE FROM `corporate1`.`transaction_ledger` WHERE `transaction_ledger`.`id` = 12867 ");
...
mysql_query("UPDATE   `corporate1`.`transaction` SET `interest` = '0', `details` = 'goldloan Refund' WHERE `transaction`.`id` = 3548");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =3566");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =7157");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =7867");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =18512");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =4565");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =7916");

mysql_query("DELETE   FROM `corporate1`.`transaction` WHERE `transaction`.`id` = 8741");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =16643");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'enterpriseloan Refund' WHERE  `transaction`.`id` =5751");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'enterpriseloan Refund' WHERE  `transaction`.`id` =7831");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'enterpriseloan Refund' WHERE  `transaction`.`id` =8749");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'enterpriseloan Refund'  WHERE  `transaction`.`id` =18281");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'demand_loan Refund' WHERE  `transaction`.`id` =6459");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'enterpriseloan Refund' WHERE  `transaction`.`id` =6878");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'enterpriseloan Refund' WHERE  `transaction`.`id` =16652");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'grouploan Refund' WHERE  `transaction`.`id` =7607");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'grouploan Refund' WHERE  `transaction`.`id` =18597");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =7663");

mysql_query("DELETE   FROM `corporate1`.`transaction` WHERE `transaction`.`id` = 7672");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =7665");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =16619");

mysql_query("DELETE   FROM `corporate1`.`transaction` WHERE `transaction`.`id` = 7674");

mysql_query("DELETE   FROM `corporate1`.`transaction` WHERE `transaction`.`id` = 29347");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =7791");

mysql_query("DELETE   FROM `corporate1`.`transaction` WHERE `transaction`.`id` = 7447");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =7991");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'businessloan Refund' WHERE  `transaction`.`id` =16656");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `interest` =  '0',`details` =  'grouploan Refund' WHERE  `transaction`.`id` =18377");

mysql_query("INSERT  INTO `corporate1`.`transaction` (`id`, `transactionid`, `customerid`, `accountno`, `amount`, `interest`, `date`, `details`, `agentid`, `type`, `mode_of_payment`, `chq_dd_no`, `chq_dd_bank_name`, `chq_dd_date`, `transaction`, `voucher`, `folio_no`, `productfolio`, `previous_amt`, `total_amt`, `ip`, `user`) VALUES (NULL, '1472105363', 'c3618', 'EL1698', '5665.00', '0', '2016-08-25', 'enterpriseloan Refund', '4', '', 'cash', '', '', '0000-00-00', '', '9665', '9', '0', '0.00', '0.00', '', '')");

mysql_query("UPDATE    `corporate1`.`transaction` SET  `amount` =  '0' WHERE  `transaction`.`id` =24801");
...
mysql_query("UPDATE    `corporate1`.`transaction` SET  `amount` =  '0' WHERE  `transaction`.`id` =24846");
...
mysql_query("UPDATE    `corporate1`.`transaction` SET  `amount` =  '0' WHERE  `transaction`.`id` =24927");
...
mysql_query("UPDATE    `corporate1`.`transaction` SET  `amount` =  '0' WHERE  `transaction`.`id` =24929");
...
mysql_query("UPDATE    `corporate1`.`transaction` SET  `amount` =  '0' WHERE  `transaction`.`id` =24930");
