   ...
   // echo "</br>";
    ...
    if($table=='compulsarydeposite')
    {
	 ...
	 $sqlagent=mysql_query("select * from `agent`")or die(mysql_error());
	  //$sqlagent=mysql_query("select * from `agent` where `prodetails`='Group Loan'")or die(mysql_error());
...
<div class="row">
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-plus"></i>Group Loan Approval Form</h2>
	...
	<!----pop up end------>
                <form name="arrange" action="grouploan_details_action.php" method="post"  enctype="multipart/form-data">
